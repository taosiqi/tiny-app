...
- 支持将失败项带回对应工具页重新执行，以及 JSON / CSV 报告导出
...
- 可一次添加 MP3、OGG、WAV 文件或目录，并按原扩展名自动选择压缩策略
- 可在首选项中分别设置 MP3、OGG、WAV 的码率、采样率和声道
...
1. 打开“任务中心”
2. 在“任务记录”中搜索、删除或导出 JSON / CSV 报告
3. 在“结果对比”中查看成功文件
4. 必要时将失败项带回对应工具页重新执行

### 图片压缩

1. 打开“图片压缩”页签
2. 在首选项的“图片压缩”中添加并校验 TinyPNG API Key
3. 添加图片文件或目录
4. 如需递归处理，在首选项中开启图片目录扫描
5. 点击“开始压缩”
...
2. 添加音频文件或目录
3. 点击“开始压缩”
4. 可在处理中暂停任务，失败项可单独重试
5. 在“处理日志 / 压缩对比”查看结果，必要时可“还原”
